...
cd $TMPDIR
/usr/lib64/openmpi/1.4-icc/bin/mpirun -wd ${OUTPUT} -np 4 /afs/ifh.de/user/k/kostrzew/code/tmLQCD.kost/build_mpi_etmc/hmc_tm -f /afs/ifh.de/user/k/kostrzew/code/tmLQCD.kost/build_mpi_etmc/sample-${BASENAME}.input -o ${TMPDIR}/output
cp ${TMPDIR}/* ${OUTPUT}
