...
cd $TMPDIR
/afs/ifh.de/user/k/kostrzew/code/tmLQCD-5.1.6/build_serial/hmc_tm -f /afs/ifh.de/user/k/kostrzew/code/tmLQCD-5.1.6/build_serial/continue_sample-${BASENAME}.input
cp -b ${TMPDIR}/* ${OUTPUT}
